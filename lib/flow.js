...
let reportDir = function reportDir(cb) {
  ...
  this.emitter.on('master:end', (context, summary) => {
    // fixme when do the date directories get created here? (they always failed for me)
    console.log('do we want to write summary files?');
