  ...
  function createNemo() {
    ...
    return NemoCore.Configure(instanceConfig.profile.conf.baseConfigPath)
      .then(function (nemoBaseConfig) {
        ...
        // no instanceConfig.basedir, so read config from instanceConfig.configFile instead
        let JSConfig = require(instanceConfig.configFile);
        return NemoCore.Configure(Object.assign({}, JSConfig, {
          driver: driverConf,
          data: dataConf
        }));
      })
